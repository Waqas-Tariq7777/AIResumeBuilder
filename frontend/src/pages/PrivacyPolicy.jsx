        ...
        <div className="relative rounded-3xl border border-zinc-800/80 bg-zinc-900/10 p-8 sm:p-12 shadow-2xl backdrop-blur-2xl space-y-8">
          ...
          <div className="space-y-6 text-sm leading-relaxed text-zinc-400">
            ...
            <section className="space-y-3">
              ...
              <p>
                At **NexResumeBuilder**, we collect resume text descriptions, experience descriptions, and profile metadata strictly to perform AI content enhancements. We process inputs dynamically via our secure models.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-white tracking-wide">2. How We Process Data</h2>
              <p>
                All resume descriptions entered into the NexResumeBuilder live enhancer workspace are processed instantly in real-time. We never store, cache, sell, or reuse personal work histories for training models or aggregators.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-white tracking-wide">3. Information Security</h2>
              <p>
                We implement state-of-the-art administrative and technical security measures (including SSL data encryption) to prevent unauthorized access, alteration, disclosure, or destruction of your professional documents.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-white tracking-wide">4. Contact Inquiries</h2>
              <p>
                For any privacy questions or metadata deletion requests, feel free to reach out to our administration at:
              </p>
